...
<body>
    ...
    <div class="isi">
        <p>Dengan Hormat,</p>
        <p>Menindak lanjuti surat permohonan izin saudara/saudari perihal permohonan cuti, saya yang bertanda tangan
            dibawah ini:</p>
        <table>
            <tr>
                <td>Nama</td>
        ...
        <p>Dan {{ $status == 'setujui' ? 'Disetujui' : 'Di Tolak' }}, izin untuk tidak masuk bekerja pada tanggal
            {{ $cuti->tanggal_mulai }} sampai dengan {{ $cuti->tanggal_selesai }}.</p>
